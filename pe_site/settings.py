"""
Django settings for pe_site project.
...
SECRET_KEY = '22r=l5^um9xrept7(t+aql2842fu^w$)1sfj_90%5bm#xl0lup'
...
ROOT_URLCONF = 'pe_site.urls'

WSGI_APPLICATION = 'pe_site.wsgi.application'
