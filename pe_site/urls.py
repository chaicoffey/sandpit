...
urlpatterns = patterns('',
    ...
    url(r'^school/list/(?P<school_list_tab_id>\w+)', 'fitness_scoring.views.school_list', name='school_list'),
    ...
    url(r'^test_category/list/(?P<test_category_list_tab_id>\w+)', 'fitness_scoring.views.test_category_list', name='test_category_list'),
