...
urlpatterns = patterns(
    ...
    url(r'^allocate_default_tests/', 'fitness_scoring.views.allocate_default_tests', name='allocate_default_tests'),
    ...
    url(r'^class/add/$', 'fitness_scoring.views.class_add'),
    url(r'^class/add/(?P<load_from_class_pk>\w+)/$', 'fitness_scoring.views.class_add'),
    url(r'^class/adds/', 'fitness_scoring.views.class_adds', name='class_adds'),
    url(r'^class/edit/(?P<class_pk>\d+)/$', 'fitness_scoring.views.class_edit'),
    url(r'^class/edit/(?P<class_pk>\d+)/(?P<load_from_class_pk>\w+)/$', 'fitness_scoring.views.class_edit'),
