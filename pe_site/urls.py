...
urlpatterns = patterns(
    ...
    url(r'^class/results_graphs/previous/(?P<class_pk>\d+)/(?P<student_pk>\d+)/(?P<test_pk>\d+)/$',
        'fitness_scoring.views.class_results_graphs_previous'),
    url(r'^class/test/add/(?P<class_pk>\d+)/$', 'fitness_scoring.views.add_test_to_class'),
    url(r'^class/test/add/(?P<class_pk>\d+)/(?P<load_from_class_pk>\d+)/$', 'fitness_scoring.views.add_test_to_class'),
